...
reshape_gene <- function(this_chunk) {
  ...
  # Return table
  all_att <- c("type", "product", "start", "end", "db_xref",
...
parse_genbank_file <- function(file_in, fasta_in) {
